<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"
    import = "com.brainfart.dbapplication.* , java.util.List, java.util.ArrayList, java.sql.* " %>
<!DOCTYPE HTML>
<html>
	...
	<body>
		...
		<header id="wrapper-header">
			<div id="main-header" class="object">
				<div class="logo"><a href="about" title="Brainfart"><img src="img/about/brainfart-logo.png" alt="logo burstfly"></a></div>
        ...
        <div id="wrapper-container">
            ...
            <div class="container object">
                ...
                <form role="form" method="post" action="handler.php" id="test01">
					<ol>
        			...
        			<% for (Question question : qlist){ %>
            			...
            			<li>
                    		<div class="<% out.print(type); %>">
                    		
                    			<h3> <% out.print(question.getContent()); %> </h3>
                    			<% List<Answer> alist = question.getAnswers(); %>
                    			<% int value = 1; %>
                    			<% for (Answer answer : alist) { %>
                        			<div class="<% out.print(type); %>">

                                	<label><input type="<% out.print(type); %>" name="opt<% out.print(type); %>" value="<% out.print(value); %>">"<% out.print(answer.getContent()); %>"</label>
        			...
        			<% } %>
						...
						<li>
							<div class="form-group">
								<h3>Опишите правила построения браузером абзаца на экране</h3>
								<label for="comment">Браузер строит абзац следующим образом:</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputLastName" name="inputLastName" value="" placeholder="Фамилия"
                                   >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputPhone" name="inputPhone" placeholder="Телефон">
                        </div>
                    </div>
